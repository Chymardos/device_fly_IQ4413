...
public class Startup extends BroadcastReceiver {
    ...
    private boolean hasTouchscreenGestures() {
        return new File(Constants.TOUCHSCREEN_S2W_NODE).exists() &&
            new File(Constants.TOUCHSCREEN_S2S_NODE).exists() &&
            new File(Constants.TOUCHSCREEN_S2WI_NODE).exists() &&
            new File(Constants.TOUCHSCREEN_DT2S_NODE).exists() &&
            new File(Constants.TOUCHSCREEN_DT2W_NODE).exists() &&
            new File(Constants.TOUCHSCREEN_VIBRATE_NODE).exists();
    }
